const totalImages = 3; // Adjust this to reflect the number of images in the folder
let currentIndex = 0;
const images = Array.from({ length: totalImages }, (_, i) => `releasephotos/image${i + 1}.png`);
